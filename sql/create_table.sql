...
CREATE INDEX idx_expense_payment_by ON expense(payment_by);
CREATE INDEX idx_expense_payment_date ON expense(payment_date);
CREATE INDEX idx_expense_deleted_at ON expense(deleted_at);
CREATE INDEX idx_expense_log_expense_id ON expense_log(expense_id);
CREATE INDEX idx_expense_log_group_id ON expense_log(group_id);
CREATE INDEX idx_expense_log_created_at ON expense_log(created_at);
CREATE INDEX idx_category_group_id ON category(group_id);
CREATE INDEX idx_template_group_id ON template(group_id);
CREATE INDEX idx_template_detail_template_id ON template_detail(template_id);
